...
import { addCliente } from "../api/clientes_potenciales";
...
export default function CrearClientepotencial(props) {
    ...
    return(
        <KeyboardAwareScrollView extraScrollHeight={25} style={{ margin: 30 }}>
            <View style={styles.container}>
                    <Text style={styles.title}>Crear Cliente Potencial</Text>
            </View>
            <TextInput
                label="CIF"
