...
import { getDatoscliente } from "../api/clientes_potenciales";
//Importamos el componente que gestionará las fotos
import DocumentPicker from 'react-native-document-picker';
import SelectBox from 'react-native-multi-selectbox';
import { xorBy } from 'lodash';
import {launchCamera, launchImageLibrary} from 'react-native-image-picker';
import { actClientepotencial } from "../api/clientes_potenciales";
...
export default function EditarClientepotencial(props) {
    ...
    //Abajo definimos que si recibimos los parametros lo rellene.
              ...
              ( async () => {
                  ...
                  if(params?.idAddress){
                      ...
                      console.log("MOSTRAMOS "+response.address);
                      await formik.setFieldValue("cif", response.address.cif);
                  }
              })()
            ...
            onSubmit: async (formData) => {
              //formData.append('Imagen', { Imagen: imagenBase });
                ...
                try {
                    ...
                    const response = await actClientepotencial(auth, idCliente, formData);
