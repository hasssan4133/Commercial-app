...
import { getVisitas } from "../api/visitas";
...
import { getVisitasfiltro } from "../api/visitas";
    ...
    useFocusEffect(
        useCallback(
            () => {
                setPartes(null);
                (async() => {
                    const response = await getVisitas(auth.token);
   ...
   // Importamos los clientes:
              ...
              onSubmit: async (formData) => {
                //formData.append('Imagen', { Imagen: imagenBase });
                  ...
                  try {
                      ...
                      const response = await getVisitasfiltro(auth, formData);
    ...
    return(
        <ScrollView style={styles.container}>
            <Text style={styles.tittle}>Listar todas las visitas</Text>
