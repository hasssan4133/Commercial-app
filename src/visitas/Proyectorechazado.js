...
import { saveResultadorechazado } from "../api/visitas";
            ...
            onSubmit: async (formData) => {
                ...
                try {
                  ...
                  const location = await Location.getCurrentPositionAsync({
                    ...
                    const response = await saveResultadorechazado(auth, formData, params.idAddress, location.coords.latitude, location.coords.longitude);
    ...
    return(
        <KeyboardAwareScrollView extraScrollHeight={25} style={{ margin: 30 }}>
            <View style={styles.container}>
                    <Text style={styles.title}>Proyecto Rechazado</Text>
            </View>
            <TextInput
                label="Introduce el motivo del rechazo"
